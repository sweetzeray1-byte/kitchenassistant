...
export function ChatFab() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-[calc(1.25rem+env(safe-area-inset-bottom))] right-[calc(1.25rem+env(safe-area-inset-right))] z-40 flex items-center gap-2 rounded-full bg-brand px-4 py-3.5 text-white shadow-lg shadow-brand/30 transition-transform hover:scale-105 active:scale-95"
    >
